                ...
                <table class="table align-items-center mb-0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Part Name
                            </th>
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="text-xs font-weight-bold mb-0 px-2">
                                        {{ $part->part_name_eng ?: $part->part_name_thai }}</p>
                                </td>
                                <td class="align-middle text-center">
                                    <span
                                        class="text-secondary text-xs font-weight-bold">{{ $part->stock?->qty ?? 0 }}</span>
                                </td>
                                <td class="align-middle text-center">
                                    @can('adjust stock')
                                        ...
                                        <button type="button" class="btn btn-link text-secondary mb-0" data-bs-toggle="modal"
                                            data-bs-target="#adjustModal-{{ $part->id }}" title="Adjust Stock">
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="text-center p-3">No parts found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
