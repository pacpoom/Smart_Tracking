<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0 d-flex flex-column align-items-center" href="{{ route('dashboard') }}">
      {{-- แก้ไข: เพิ่ม border-radius: 8px; --}}
      <img src="{{ asset('assets/img/logo.png') }}" alt="main_logo" style="max-height: 48px; width: auto; border-radius: 8px;">
      <span class="mt-2 font-weight-bold text-white">AnJi-Logistics</span>
    </a>
  </div>
