                ...
                <table class="table align-items-center mb-0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Vessel</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><p class="text-xs font-weight-bold mb-0 px-2">{{ $plan->container->container_owner }}</p></td>
                            ...
                            <td><p class="text-xs font-weight-bold mb-0 px-2">{{ $plan->vessel }}</p></td>
