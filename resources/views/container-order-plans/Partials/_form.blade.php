    ...
    <div class="col-md-6 mb-3">
        ...
        <div class="input-group input-group-outline">
            <input type="text" class="form-control" name="model"
                value="{{ old('model', $containerOrderPlan->model ?? '') }}">
        </div>
    </div>
    <div class="col-md-6 mb-3">
        ...
        <div class="input-group input-group-outline">
            <input type="text" class="form-control" name="type"
                value="{{ old('type', $containerOrderPlan->type ?? '') }}">
        </div>
    </div>
</div>
<div class="row">
    <div class="col-md-6 mb-3">
        ...
        <div class="input-group input-group-outline">
            <input type="text" class="form-control" name="house_bl"
                value="{{ old('house_bl', $containerOrderPlan->house_bl ?? '') }}">
        </div>
    </div>
    <div class="col-md-6 mb-3">
        <label class="form-label">Free Time (days)</label>
        <div class="input-group input-group-outline">
            <input type="number" class="form-control" name="free_time"
                value="{{ old('free_time', $containerOrderPlan->free_time ?? '') }}">
        </div>
    </div>
</div>
<div class="row">
    <div class="col-md-6 mb-3">
        ...
        <div class="input-group input-group-outline">
            <input type="text" class="form-control" name="depot"
                value="{{ old('depot', $containerOrderPlan->depot ?? '') }}">
        </div>
        @error('depot')
    ...
    <div class="col-md-6 mb-3">
        ...
        <div class="input-group input-group-outline">
            <input type="date" class="form-control" name="eta_date"
                value="{{ old('eta_date', isset($containerOrderPlan) ? $containerOrderPlan->eta_date?->format('Y-m-d') : '') }}">
        </div>
        @error('eta_date')
            <p class="text-danger text-xs pt-1"> {{ $message }} </p>
        @enderror
    ...
    <div class="col-md-6 mb-3">
        ...
        <div class="input-group input-group-outline">
            <input type="date" class="form-control" name="checkin_date"
                value="{{ old('checkin_date', isset($containerOrderPlan) ? $containerOrderPlan->checkin_date?->format('Y-m-d') : '') }}">
        </div>
        @error('checkin_date')
            <p class="text-danger text-xs pt-1"> {{ $message }} </p>
        @enderror
