        ...
        <div class="card-header pb-0">
            <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-md-between">
                ...
                <div class="d-flex align-items-center">
                    ...
                    {{-- ✅ FIX: Changed search input to floating label style --}}
                    <form action="{{ route('pfeps.index') }}" method="GET" class="me-2">
                        <div class="input-group input-group-outline">
                            <label class="form-label">Search by Material...</label>
                            <input type="text" class="form-control" name="search" value="{{ request('search') }}">
                        </div>
                    </form>

                    <a href="{{ route('pfeps.create') }}" class="btn btn-primary mb-0">Add New PFEP</a>
                </div>
            </div>
        </div>
                ...
                <table class="table align-items-center mb-0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Pull Type
                            </th>
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Line Side
                            </th>
                    ...
                    <tbody>
                        @forelse ($pfeps as $pfep)
                            <tr>
                                <td>
                                    <p class="text-xs font-weight-bold mb-0 px-2">{{ $pfep->material->material_number }}</p>
