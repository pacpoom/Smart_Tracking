                ...
                <div class="table-responsive p-0">
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    <td class="text-center">
                                        <div class="form-check d-flex justify-content-center"><input
                                                class="form-check-input part-checkbox" type="checkbox" name="ids[]"
                                                value="{{ $part->id }}"></div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <p class="text-xs font-weight-bold mb-0 px-2">{{ $part->part_name_thai }}</p>
                                    </td>
                                    <td>
                                        <p class="text-xs font-weight-bold mb-0 px-2">{{ $part->model_no }}</p>
                                    </td>
                                    <td class="align-middle text-center"><span
                                            class="text-secondary text-xs font-weight-bold">{{ $part->unit }}</span></td>
                                    <td class="align-middle text-center">
                                        ...
                                        @can('delete parts')
                                            <button type="button" class="btn btn-link text-danger mb-0" data-bs-toggle="modal"
                                                data-bs-target="#deleteModal-{{ $part->id }}" title="Delete"><i
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center p-3">No parts found.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
